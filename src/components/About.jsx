      ...
      <div className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-12">
          <div className="max-w-3xl">
            <AnimatedText
              text="I’m a proficient software engineer with hands-on experience building web applications and digital products. I focus on clean UI, strong UX patterns, and pragmatic engineering."
            />
