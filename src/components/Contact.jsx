      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-12">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <div>
                ...
                <div className="flex flex-col gap-3 text-gray-800 text-base md:text-lg">
                  {/* LinkedIn */}
                  <a
                  ...
                  >
                    <Linkedin className="text-indigo-600" size={22} />
                    <span>LinkedIn</span>
                  </a>
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 hover:text-indigo-600 transition"
                  >
                    <Github className="text-indigo-600" size={22} />
                    <span>GitHub</span>
                  </a>
                </div>
              </div>
          ...
          >
            ...
            <div className="mt-4">
              <label className="block font-semibold mb-1 text-left text-gray-800">Name</label>
              <input
                type="text"
            ...
            <div className="mt-4">
              <label className="block font-semibold mb-1 text-left text-gray-800">Email</label>
              <input
                type="email"
                className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400"
            ...
            <div className="mt-4">
              <label className="block font-semibold mb-1 text-left text-gray-800">Message</label>
              <textarea
                className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400"
                rows="5"
...
//                 <p className="text-gray-800">+256 758 845 925</p>
//               </div>
//             </div>
...
//                 <p className="text-gray-800">Kampala, Uganda</p>
//               </div>
//             </div>

//             {/* Socials */}
//             <div className="flex items-center gap-4">
//               <Linkedin className="text-indigo-600" size={26} />
//               <div>
//                 <h3 className="font-semibold text-xl">Socials</h3>
//                 <div className="flex gap-4 text-gray-800 text-lg mt-1">
//                   <a
//                     href="https://www.linkedin.com/in/naula-lorna-3513732b5"
//                     target="_blank"
//                     rel="noopener noreferrer"
