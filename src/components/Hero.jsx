...
//         {/* Main Photo below the title */}
//         <div className="relative flex justify-center items-center mb-8">
//           {/* Glow rings (lighter and farther back so they don't cover photo) */}
//           <div className="absolute w-96 h-96 rounded-full border-2 border-indigo-500/20 blur-sm -z-10"></div>
//           <div className="absolute w-112 h-112 rounded-full border-2 border-pink-500/15 blur-md -z-20"></div>
...
//           {/* Main Photo */}
//           <div className="w-64 h-64 md:w-72 md:h-72 rounded-full border-4 border-indigo-300 shadow-2xl 
//                           overflow-hidden flex justify-center items-center bg-transparent z-10">
//             <img
//               src={myPhoto}
//               alt="Lorna Naula"
...
//         {/* Main Photo */}
//         <div className="relative flex justify-center items-center mb-8">
//           {/* Glow rings moved far back or removed */}
...
//           {/* Orbiting Rockets (moved slightly outside so they don't cover face) */}
//           <motion.div
//             className="absolute text-indigo-400"
//             style={{ originX: 2, originY: 2 }}
//             initial={{ rotate: 0 }}
